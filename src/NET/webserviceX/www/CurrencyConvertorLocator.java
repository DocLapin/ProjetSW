...
public class CurrencyConvertorLocator extends org.apache.axis.client.Service implements NET.webserviceX.www.CurrencyConvertor {
    ...
    public NET.webserviceX.www.CurrencyConvertorSoap getCurrencyConvertorSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public NET.webserviceX.www.CurrencyConvertorSoap getCurrencyConvertorSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            NET.webserviceX.www.CurrencyConvertorSoap12Stub _stub = new NET.webserviceX.www.CurrencyConvertorSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            ...
            if (NET.webserviceX.www.CurrencyConvertorSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                NET.webserviceX.www.CurrencyConvertorSoap12Stub _stub = new NET.webserviceX.www.CurrencyConvertorSoap12Stub(new java.net.URL(CurrencyConvertorSoap12_address), this);
                _stub.setPortName(getCurrencyConvertorSoap12WSDDServiceName());
                return _stub;
            }
        }
